						...
						<form class="card card-primary" method="post" action="/free/insert.do" id="freeForm">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" id="boTitle" class="form-control" name="boTitle" value="${free.boTitle }" placeholder="제목을 입력해주세요">
								</div>
								<div class="form-group">
									<label for="inputDescription">내용을 입력해주세요</label>
									<textarea id="boContent" class="form-control" rows="14" name="boContent">${free.boContent }</textarea>
								</div>
								<div class="row">
									<div class="col-12">
									<!-- 
