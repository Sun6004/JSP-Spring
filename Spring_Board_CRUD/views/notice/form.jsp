...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		<nav
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" data-widget="pushmenu" href="/main.do" role="button"> 
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column"
						...
						<li class="nav-item"><a href="#" class="nav-link"> <i
								...
								<p>
									공지 게시판${name } <i class="right fas fa-angle-left"></i>
								</p>
						</a></li>
					</ul>
				</nav>
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">공지 게시판${name } </li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="row">
					<div class="col-md-12">
						<form class="card card-primary" method="post" action="/notice/insert.do" id="noticeForm">
							<c:if test="${status eq 'u' }">
								<input type="hidden" name="boNo" value="${notice.boNo }">
							</c:if>
							<div class="card-header">
								<h3 class="card-title">공지게시판 ${name }</h3>
								<div class="card-tools"></div>
							</div>
							<div class="card-body">
								<div class="form-group">
									<label for="inputName">제목을 입력해주세요</label> 
									<input type="text" id="boTitle" class="form-control" name="boTitle" value="${notice.boTitle }" placeholder="제목을 입력해주세요">
								</div>
								<div class="form-group">
									<label for="inputDescription">내용을 입력해주세요</label>
									<textarea id="boContent" class="form-control" rows="14" name="boContent">${notice.boContent }</textarea>
								</div>
								<div class="row">
									<div class="col-12">
									<!-- 
