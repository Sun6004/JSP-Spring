		...
		<div class="row">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span class="badge badge-success" id="zxc">전체  ${boardLength } 건</span>
						</div>
					</div>
			...
			<div class="col-md-6">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span class="badge badge-success" id="zxc">전체  ${noticeLength } 건 </span>
						</div>
					</div>
					<div style="padding-top: 50px">
						<table class="table">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span class="badge badge-success" id="zxc">전체  ${freeLength } 건</span>
						</div>
					</div>
					<div style="padding-top: 50px">
						<table class="table">
...
<script type="text/javascript">
	$(function(){
		...
		$('.tr1').on('click', function(){
			 var boNo1 = $(this).find('td:first').text();
			 location.href = "/board/detail.do?boNo=" + boNo1;
		})
		$('.tr2').on('click', function(){
			 var boNo2 = $(this).find('td:first').text();
			 location.href = "/notice/detail.do?boNo=" + boNo2;
		})
		$('.tr3').on('click', function(){
			 var boNo3 = $(this).find('td:first').text();
			 location.href = "/free/detail.do?boNo=" + boNo3;
		})
	})
</script>
</html>