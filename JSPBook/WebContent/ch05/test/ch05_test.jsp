                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<!-- 
                                	 ...
                                	 -->
                                	 <form action="ch05_test_process.jsp" method="get">
                                	 ...
                                	 <br>
                                	 gender: <input type="radio" name="gen" value="male"> 남성
                                	 ...
                                	 <label> <input type="checkbox" name="hobby" value="eat">먹기 </label>
                                	 <br>
                                	 ...
                                	 introduce 
                                	 <br>
                                	 <textarea rows="8" cols="30" name="intro"></textarea>
                                	 <br>
