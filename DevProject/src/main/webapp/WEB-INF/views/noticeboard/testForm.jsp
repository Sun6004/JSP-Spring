						...
						<div class="tab-content p-0">
							...
							<div class="chart tab-pane active" id="revenue-chart"
								...
								<canvas id="revenue-chart-canvas" height="300"
									style="height: 300px; display: block; width: 340px;"
				...
				<div class="card bg-gradient-primary">
					...
					<div class="card-body">
						<div id="world-map"
							...
							<svg width="339.578" height="250">
								<g
									transform="scale(0.3540959332638165) translate(0, 56.511679201832834)">
								<path
				...
				<div class="card bg-gradient-info">
					...
					<div class="card-body">
						...
						<canvas class="chart chartjs-render-monitor" id="line-chart"
							style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 340px;"
							width="340" height="250"></canvas>
					</div>
									...
									<li class="show"><div class="datepicker">
											<div class="datepicker-days" style="">
												<table class="table table-sm">
													<thead>
														<tr>
															...
															<th class="picker-switch" data-action="pickerSwitch"
																colspan="5" title="Select Month">June 2023</th>
													...
													<tbody>
														<tr>
															<td data-action="selectDay" data-day="05/28/2023"
																class="day old weekend">28</td>
															<td data-action="selectDay" data-day="05/29/2023"
																class="day old">29</td>
															<td data-action="selectDay" data-day="05/30/2023"
																class="day old">30</td>
															<td data-action="selectDay" data-day="05/31/2023"
																class="day old">31</td>
															<td data-action="selectDay" data-day="06/01/2023"
																class="day">1</td>
															<td data-action="selectDay" data-day="06/02/2023"
																class="day">2</td>
															<td data-action="selectDay" data-day="06/03/2023"
																class="day weekend">3</td>
														</tr>
														<tr>
															<td data-action="selectDay" data-day="06/04/2023"
																class="day weekend">4</td>
															<td data-action="selectDay" data-day="06/05/2023"
																class="day">5</td>
															<td data-action="selectDay" data-day="06/06/2023"
																class="day">6</td>
															<td data-action="selectDay" data-day="06/07/2023"
																class="day">7</td>
															<td data-action="selectDay" data-day="06/08/2023"
																class="day active today">8</td>
															<td data-action="selectDay" data-day="06/09/2023"
																class="day">9</td>
															<td data-action="selectDay" data-day="06/10/2023"
																class="day weekend">10</td>
														</tr>
														<tr>
															<td data-action="selectDay" data-day="06/11/2023"
																class="day weekend">11</td>
															<td data-action="selectDay" data-day="06/12/2023"
																class="day">12</td>
															<td data-action="selectDay" data-day="06/13/2023"
																class="day">13</td>
															<td data-action="selectDay" data-day="06/14/2023"
																class="day">14</td>
															<td data-action="selectDay" data-day="06/15/2023"
																class="day">15</td>
															<td data-action="selectDay" data-day="06/16/2023"
																class="day">16</td>
															<td data-action="selectDay" data-day="06/17/2023"
																class="day weekend">17</td>
														</tr>
														<tr>
															<td data-action="selectDay" data-day="06/18/2023"
																class="day weekend">18</td>
															<td data-action="selectDay" data-day="06/19/2023"
																class="day">19</td>
															<td data-action="selectDay" data-day="06/20/2023"
																class="day">20</td>
															<td data-action="selectDay" data-day="06/21/2023"
																class="day">21</td>
															<td data-action="selectDay" data-day="06/22/2023"
																class="day">22</td>
															<td data-action="selectDay" data-day="06/23/2023"
																class="day">23</td>
															<td data-action="selectDay" data-day="06/24/2023"
